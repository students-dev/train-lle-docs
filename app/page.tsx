...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-gray-400">Train models locally without sending data to the cloud</p>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-4">⚡</div>
            <h3 className="text-xl font-semibold mb-2">Fast & Efficient</h3>
            <p className="text-gray-400">Direct on-device training with zero dependencies</p>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-4">🛠️</div>
            <h3 className="text-xl font-semibold mb-2">Developer Friendly</h3>
            <p className="text-gray-400">TypeScript support with intuitive API design</p>
          </div>
        </div>
      </div>
      ...
      {/* CTA Section */}
      <div className="container mx-auto px-6 py-20">
        <div className="text-center bg-gray-800 rounded-lg p-12 max-w-4xl mx-auto">
